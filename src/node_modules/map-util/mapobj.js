...
class TMap extends ol.Map {
    constructor() {
        ...
        let viewOpts = {
            ...
            extent: config.object('map.extent'),
            minResolution: scaleToResolution(scales[0]),
            maxResolution: scaleToResolution(scales[scales.length - 1]),
            resolution: scaleToResolution(scales[scales.length >> 1]),
