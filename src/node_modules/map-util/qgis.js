...
async function request(params) {
    let res = await axios.get(config.str('qgis.server'), {
        params: Object.assign({}, params, {
            map: config.str('qgis.map'),
...
async function load(map) {
    ...
    let la = parseLayer(caps.Capability[0].Layer[0]);
    map.addLayer(la);
